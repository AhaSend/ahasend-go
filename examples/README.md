...
- [send_with_template.go](./send_with_template.go) - Send email using HTML templates
...
### SMTP Credentials
- [smtp_credentials.go](./smtp_credentials.go) - Manage SMTP credentials for legacy applications

### Suppressions
- [suppressions.go](./suppressions.go) - Manage email suppression lists
